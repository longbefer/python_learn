...
# i = Image.open('Python/images/dotndot.png')
# iar = np.asarray(i) # 将i作为数组赋值给ia
# print(iar) # 打印iar
...
# print("start cv2")
# import cv2
# img = cv2.imread('Python/images/sentdex.png')
# cv2.imshow('image',img)
# cv2.waitKey(0)
# cv2.destroyAllWindows()
# print("end cv2")
...
i1 = Image.open('Python/images/dot.png')
iar1 = np.asarray(i1) # 将i作为数组赋值给ia

i2 = Image.open('Python/images/dotndot.png')
iar2 = np.asarray(i2) # 将i作为数组赋值给ia

i3 = Image.open('Python/images/sentdex.png')
iar3 = np.asarray(i3) # 将i作为数组赋值给ia

i4 = Image.open('Python/images/blank.png')
iar4 = np.asarray(i4) # 将i作为数组赋值给ia
