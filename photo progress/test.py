...
# baseImageBtn = 
Button(root, text="选择底图", command=chooseBaseImagePath).place(x=10, y=30)
ImagesLabel = Label(root, text='')
ImagesLabel.place(x=10, y=60)
# ImagesBtn = 
Button(root, text="选择合成图文件夹", command=chooseImagesPath).place(x=10, y=80)
...
# scaleLabel = 
Label(root, text='透明度').place(x=10, y=170)
...
# generatorBtn = 
Button(root, text="生成", command=test).place(x=10, y=220)
